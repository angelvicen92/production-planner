...
- **Objetivo y alcance (`DB Safe Merge`):** preflight puro, determinista y profundamente read-only de `EngineInput`; materializa identidades y audita contratos inspeccionables sin crear `PlannerNextProblem`, adaptar entidades, ejecutar Planner Next/ORC/V3/V4 ni producir o modificar planificación. Distingue duración ausente (`MISSING_TASK_DURATION`) de presente inválida (`UNSUPPORTED_TIME_VALUE`), dependencia repetida (`DUPLICATE_DEPENDENCY_REFERENCE`) de ciclo, y una tarea sin concursante queda como rol no resoluble sin inventar un falso participante.
- **Auditoría contractual:** mapa reversible de plan, task, lock, participant, space, zone, plan-resource, resource-item, resource-type, template, itinerant-team y break; coaches exclusivamente desde `coachResourceIds`; componentes, requisitos y asignaciones por su namespace real; espacio referenciado separado de espacio descrito; aliases temporales contradictorios; scopes de comidas/breaks; y las tres dimensiones de locks `full`. Política, presupuesto, rejilla y flujo principal no se infieren ni reciben defaults.
- **`real-main-stage-with-backlog` — `UNSUPPORTED`:** reason codes `MISSING_MAIN_FLOW_CONFIGURATION`, `MISSING_PARTICIPANT_AVAILABILITY`, `MISSING_RESOURCE_AVAILABILITY`, `MISSING_SEARCH_BUDGET_CONFIGURATION`, `MISSING_SEARCH_POLICY_CONFIGURATION`, `MISSING_SPACE_REFERENCE`, `MISSING_TASK_DURATION`, `UNSUPPORTED_TASK_ROLE`, `UNSUPPORTED_TIME_GRID`. Diagnóstico esencial: 3 planificables, 2 horarios previos descartables, 2 participantes, 1 espacio referenciado/0 descritos, 2 duraciones ausentes, 2 asignaciones y 0 referencias de recurso ausentes. Source `360a5a376e2714a6e9b849b7bd1a6af1b7052d766c98373f3b08572c2241ee3c`; identities `68a72d0ac8f1d2246d5a7a8132c0090b43d76bb9a2dcb59f9f4b1cdb7b5c3b89`.
- **`real-resource-lock-pressure` — `UNSUPPORTED`:** reason codes `MISSING_MAIN_FLOW_CONFIGURATION`, `MISSING_PARTICIPANT_AVAILABILITY`, `MISSING_RESOURCE_AVAILABILITY`, `MISSING_SEARCH_BUDGET_CONFIGURATION`, `MISSING_SEARCH_POLICY_CONFIGURATION`, `MISSING_SPACE_REFERENCE`, `MISSING_TASK_DURATION`, `UNREPRESENTABLE_RESOURCE_LOCK`, `UNREPRESENTABLE_SPACE_LOCK`, `UNSUPPORTED_TASK_ROLE`, `UNSUPPORTED_TIME_GRID`. Diagnóstico esencial: 3 planificables, 3 horarios descartables, 3 participantes, 3 espacios referenciados/0 descritos, 3 duraciones ausentes, 3 asignaciones y 0 referencias de recurso ausentes; el lock `full` conserva tiempo pero carece de espacio y recurso explícitos representables. Source `fffb162050a5ad34928c4ca035faa13f4c9b4af6ee5a1b3aa50198048ff011bc`; identities `794472d65522cebf41bbc687d25dccb474e8579766fd01de4a45fda48941cc65`.
- **`real-protected-break-recovery` — `UNSUPPORTED`:** reason codes `MISSING_MAIN_FLOW_CONFIGURATION`, `MISSING_PARTICIPANT_AVAILABILITY`, `MISSING_RESOURCE_AVAILABILITY`, `MISSING_SEARCH_BUDGET_CONFIGURATION`, `MISSING_SEARCH_POLICY_CONFIGURATION`, `MISSING_SPACE_REFERENCE`, `MISSING_TASK_DURATION`, `UNSUPPORTED_TASK_ROLE`, `UNSUPPORTED_TIME_GRID`. Diagnóstico esencial: 3 planificables, 2 horarios descartables, 2 participantes, 2 espacios referenciados/0 descritos, 2 duraciones ausentes, 2 asignaciones, 1 break y 0 referencias de recurso ausentes. Source `a43fdb467155531899b9d86824865d7504c07988b07ece00a3c4283346df7838`; identities `fd6782b3ba5a6104c13e70baeff7303baf48b9f1561eea76e37e4a33f58eb01a`.
- **Evidence y siguiente decisión:** 35 tests nominales y el benchmark congelan issues, diagnostics, mapas, fingerprints, input y output; repetición e inversión integral son idénticas y los horarios pendientes descartables sólo aportan presencia, nunca sus valores como semilla. Antes de cualquier adaptador deben materializarse contratos autoritativos de rol, espacios/disponibilidad, rejilla, flujo principal, política y presupuesto.
