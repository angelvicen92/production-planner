...
- **Límites:** sólo se snapshotan relaciones y ventanas temporales, no nombres, colores, prioridades, grouping ni setups. No se añade botón/endpoint “Copiar configuración predeterminada”, diff, actualización masiva, UI, RLS, `EngineInput`, Planner Next, ORC o V3/V4; no se afirma que desaparezca `MISSING_SPACE_REFERENCE`.
