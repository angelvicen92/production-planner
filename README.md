...
- **Evidence representativa:** los tres escenarios continúan `UNSUPPORTED` por blockers no espaciales legítimos, pero eliminan `MISSING_SPACE_REFERENCE` y `MISSING_SPACE_AVAILABILITY`, con `missingAvailabilityCounts.spaces = 0`. Requeridos/resolubles: `real-main-stage-with-backlog` `1/1`, source `ee7f89bdabfaa57bec7720013da926abb5beeb9e2504353c48a3fca4d42f79a8`; `real-resource-lock-pressure` `3/3`, source `208712de676bfdd5d6edac56d9f50cc30b5dd076f1db13c9b8435649888b4614`; `real-protected-break-recovery` `2/2`, source `d157c50703c595ba04dd4a80972a6b42cca90618bbf78b77095172a0464e1bb9`. Sus identity fingerprints no cambian; repetición, inversión de tareas/zones/spaces, input inmutable y output frozen quedan congelados por tests y Evidence.
- **Evidence regenerada:** dos ejecuciones de `SPEC10-009-engine-input-spatial-availability` fueron idénticas byte a byte, con `34.656` bytes y SHA-256 `60448e033ded3287fe4f9b1572c1d54843500f1b617a4fe7c5c21b9e74bc9545`; los tests focales adicionales congelan autoridad diaria frente al catálogo legacy, issue única, partial-real y locks temporales.
- **Focal A2 oficial:** `./validate-focal-a2-009r3.sh current` ejecutó instalación, check, build y 1.927 tests globales sin fallos, pero su gate final rechazó el artefacto fresco mediante `combinedUnsupportedAtomic`: el resultado actual fue `[true, 28432, 53, null]` mientras el propio validador exige `[false, 0, 0, "ANCHORED_ACCOMPANIMENT_NOT_SUPPORTED"]`. La planificación fresca sí contiene 53 tareas completas, pero SPEC10-009 no modifica el algoritmo ni el benchmark para convertir esta contradicción ajena a la integración espacial en un pass; el PR permanece abierto y no se declara Focal validado.
