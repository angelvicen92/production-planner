...
- **`real-main-stage-with-backlog` — `UNSUPPORTED`:** `MISSING_MAIN_FLOW_CONFIGURATION`, `MISSING_PARTICIPANT_AVAILABILITY`, `MISSING_RESOURCE_AVAILABILITY`, `MISSING_SEARCH_BUDGET_CONFIGURATION`, `MISSING_SEARCH_POLICY_CONFIGURATION`, `MISSING_SPACE_REFERENCE`, `MISSING_TASK_DURATION`, `UNSUPPORTED_RESOURCE_REQUIREMENT`, `UNSUPPORTED_SETUP_MAPPING`, `UNSUPPORTED_TASK_ROLE`, `UNSUPPORTED_TIME_GRID`. Diagnóstico: 3 planificables, 2 horarios descartables, 2 participantes, 1 espacio referenciado/0 descritos, 3 recursos definidos, 2 duraciones ausentes, 2 asignaciones y setup explícito. Source `74fb3271d7a4441c2ea4b4c0c04db7193b4a9bf69d5a88bdf8a4850e260f0812`; identities `68a72d0ac8f1d2246d5a7a8132c0090b43d76bb9a2dcb59f9f4b1cdb7b5c3b89`.
- **`real-resource-lock-pressure` — `UNSUPPORTED`:** `MISSING_MAIN_FLOW_CONFIGURATION`, `MISSING_PARTICIPANT_AVAILABILITY`, `MISSING_RESOURCE_AVAILABILITY`, `MISSING_SEARCH_BUDGET_CONFIGURATION`, `MISSING_SEARCH_POLICY_CONFIGURATION`, `MISSING_SPACE_REFERENCE`, `MISSING_TASK_DURATION`, `UNREPRESENTABLE_RESOURCE_LOCK`, `UNREPRESENTABLE_SPACE_LOCK`, `UNSUPPORTED_SETUP_MAPPING`, `UNSUPPORTED_TASK_ROLE`, `UNSUPPORTED_TIME_GRID`. Diagnóstico: 3 planificables/horarios descartables/participantes/espacios referenciados/recursos definidos, 0 espacios descritos, 3 duraciones ausentes, 3 asignaciones y setup explícito; el lock `full` conserva tiempo pero no espacio/recurso explícitos representables. Source `968d5e471bfe73c829ec5ac1a1c35c2f8e1a1f617310b26c0543fcd0755fb9c0`; identities `794472d65522cebf41bbc687d25dccb474e8579766fd01de4a45fda48941cc65`.
...
- **Evidence y siguiente decisión:** 58 tests nominales y el benchmark congelan status, issues, reason codes, diagnostics, mapas, fingerprints, input y output; repetición e inversión integral son idénticas. La Evidence confirma que antes de adaptar deben evolucionar contratos autoritativos de rol, catálogos/disponibilidad, rejilla, flujo principal, política, presupuesto, cantidades, ocupación, setup y transporte.
