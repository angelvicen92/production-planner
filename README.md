...
- **Piloto explícito:** sólo se auditan 12, 13, 14, 16, 18, 19, 20, 41, 120, 121, 122, 123, 134, 135 y 136. Los 15 bindings son literales, distintos y consumen source assertions revisadas, observaciones de probes ejecutados, tests funcionales exactos y selectors de benchmark sobre valores reales.
- **Probes y derivación:** se ejecutan estados protegidos, variantes de locks, disponibilidad de coach, tarea y cadena técnica, dependencia técnica desde EngineInput, distinción transporte/tarea ordinaria y tres comidas por ámbito. Source refs y observation IDs inexistentes degradan a `NOT_AUDITED`; no existe clasificación por IDs o reason codes constantes.
