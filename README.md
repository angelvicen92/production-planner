...
- **Compatibilidad:** la presencia real de al menos un contrato `anchoredAccompaniments` detecta únicamente `ANCHORED_ACCOMPANIMENT`. La matriz declara que esta capacidad requiere `EXACT_CONSTRUCTIVE`; una política incompatible se explica con `SEARCH_POLICY_CAPABILITY_UNSUPPORTED` sin excepción, fallback ni aumento de presupuesto.
