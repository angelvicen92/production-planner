import { immutableMapView } from "./immutableMapView";
import {
  resolveEffectiveSpaceAvailabilityHierarchy,
  type AvailabilityWindow,
  type SpatialAvailabilityReason,
} from "./spatialAvailabilityHierarchy";

export interface PlanSpatialTimeWindow {
  readonly start: string;
  readonly end: string;
}

export interface PlanZoneSpatialAvailabilityInput {
...
export interface PlanSpaceSpatialAvailabilityInput {
...
export function resolveEffectivePlanSpatialAvailability(workDay: PlanSpatialTimeWindow, zones: readonly PlanZoneSpatialAvailabilityInput[] = [], spaces: readonly PlanSpaceSpatialAvailabilityInput[] = []): EffectivePlanSpatialAvailability {
