...
export const configurabilityRegistry: readonly ConfigurabilityCapability[] = Object.freeze([
  productive({...base("WORKDAY_WINDOW","Horario de la jornada","Jornada y comidas","PLAN","HH:mm",["DAY_SNAPSHOT","DAY_OVERRIDE"]),dailyPersistence:"plans.work_start/work_end",override:"PATCH plan",dayUi:"Edición del día",engineInputProjection:"workDay",preflight:"buildEngineInput",engineConsumer:"V3/V4",validator:"updatePlanSchema",evidenceFingerprint:"effective revision",tests:["engine/buildInput.operationalSnapshotGate.spec.ts"]}),
