...
export const configurabilityRegistry: readonly ConfigurabilityCapability[] = Object.freeze([
  gap("PARTIAL",["El valor efectivo se persiste en plans.work_start/work_end y llega al motor como workDay, pero no existe provenance diaria persistida/auditable que distinga INHERITED de DAY_OVERRIDE.","No se conserva el baseline heredado ni existe una operación Restore inherited con autoridad estable."],{...base("WORKDAY_WINDOW","Horario de la jornada","Jornada y comidas","PLAN","HH:mm",["GENERAL","DAY_SNAPSHOT","DAY_OVERRIDE"]),generalSource:"program_settings.default_work_start/default_work_end",dailyPersistence:"plans.work_start/work_end (valor efectivo sin provenance)",override:"Formulario de creación y PATCH plan; sin Restore inherited",generalUi:"Ajustes generales del programa > Horario habitual de la jornada",dayUi:"Creación y edición del día",engineInputProjection:"workDay",preflight:"buildEngineInput",engineConsumer:"V3/V4",validator:"insertPlanSchema/updatePlanSchema",evidenceFingerprint:"UNAVAILABLE para provenance",tests:["client/src/components/create-plan-dialog.test.ts","client/src/components/general-program-settings.test.ts","engine/buildInput.operationalSnapshotGate.spec.ts"]}),
  ...
  gap("PARTIAL",["El valor efectivo de comida se persiste en plans y llega al motor como meal/mealMode, pero no existe provenance diaria persistida/auditable que distinga INHERITED de DAY_OVERRIDE.","No se conserva el baseline heredado ni existe una operación Restore inherited con autoridad estable."],{...base("GLOBAL_MEAL_BREAK","Pausa global de comida","Jornada y comidas","PLAN","HH:mm",["GENERAL","DAY_SNAPSHOT","DAY_OVERRIDE"]),generalSource:"program_settings",dailyPersistence:"plans meal window (valor efectivo sin provenance)",override:"PATCH plan; sin Restore inherited",generalUi:"Configuración general",engineInputProjection:"meal/mealMode",preflight:"buildEngineInput",engineConsumer:"V3/V4",validator:"plan schema",evidenceFingerprint:"UNAVAILABLE para provenance",tests:["engine/buildInput.operationalSnapshotGate.spec.ts"]}),
