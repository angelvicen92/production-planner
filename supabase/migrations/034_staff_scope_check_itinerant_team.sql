-- 034_staff_scope_check_itinerant_team
-- Actualiza los CHECK constraints para soportar scope_type = 'itinerant_team'

-- staff_assignment_defaults
ALTER TABLE staff_assignment_defaults
  DROP CONSTRAINT IF EXISTS staff_assignment_defaults_scope_check;

ALTER TABLE staff_assignment_defaults
  ADD CONSTRAINT staff_assignment_defaults_scope_check CHECK (
    (
      scope_type = 'zone'
...
-- plan_staff_assignments (también tiene su constraint viejo)
