...
export type EngineDiagnosticsMetadata = {
  ...
  productionWaveReason?: string | null;
  productionWaveRejectedReasons?: string[] | null;
  productionWaveCandidateMetrics?: Array<Record<string, unknown>> | null;
  productionWaveBestBefore?: Record<string, unknown> | null;
  productionWaveBestAfter?: Record<string, unknown> | null;
  productionWaveComparison?: Record<string, unknown> | null;
  ...
  segmentSolverLeftBlockTalentNames?: string[] | null;
  segmentSolverRightBlockTalentNames?: string[] | null;
  segmentSolverMicroSegmentsBuilt?: number | null;
  segmentSolverMicroSegmentStrategiesTried?: string[] | null;
  segmentSolverMicroSegmentTaskCounts?: number[] | null;
  segmentSolverMicroSegmentRejectedReasons?: string[] | null;
  segmentSolverAssignmentsExplored?: number | null;
  segmentSolverValidCandidates?: number | null;
  segmentSolverBestCandidateMovedTaskIds?: number[] | null;
  segmentSolverBestCandidateMovedTalentNames?: string[] | null;
  ...
  segmentSolverTopBlockers?: Array<Record<string, unknown>> | null;
  segmentSolverTopResourceBlockers?: Array<Record<string, unknown>> | null;
  segmentSolverTopDependencyBlockers?: Array<Record<string, unknown>> | null;
  segmentSolverTopMealBlockers?: Array<Record<string, unknown>> | null;
  segmentSolverTopMainStageBlockers?: Array<Record<string, unknown>> | null;
  segmentSolverLocalChecksPerformed?: number | null;
  ...
  segmentSolverExpansionRejectedReasons?: string[] | null;
  segmentSolverDirectRepairsAttempted?: number | null;
  segmentSolverDirectRepairsAccepted?: number | null;
  segmentSolverDirectRepairStrategiesTried?: string[] | null;
  segmentSolverDirectRepairRejectedReasons?: string[] | null;
  segmentSolverRepairChainsAttempted?: number | null;
  segmentSolverRepairChainsAccepted?: number | null;
  segmentSolverRepairChainMaxDepthReached?: number | null;
  segmentSolverRepairChainDepths?: number[] | null;
  segmentSolverRepairChainMovedTaskIds?: number[] | null;
  segmentSolverRepairChainBlockedBy?: string[] | null;
