...
export type ORCPlanningEntryOperationalRole = "productive_task" | "meal_break_placeholder" | "arrival_placeholder" | "call_time_placeholder" | "space_break_placeholder" | "global_break_placeholder" | "non_operational_placeholder" | "unknown";
export type ORCSpaceOccupancyMode = "exclusive" | "shared" | "non_blocking";
export interface ORCOperationalRoleMetadata { role: ORCPlanningEntryOperationalRole; countsAsWork: boolean; blocksSpace: boolean; countsForMainFlow: boolean; countsForResourceLoad: boolean; countsForTalentLoad: boolean; allowsSpaceOverlap: boolean; spaceOccupancyMode: ORCSpaceOccupancyMode; warnings: string[]; readOnly: true; }
...
function roleFlags(role: ORCPlanningEntryOperationalRole, task: Record<string, unknown>, source: Record<string, unknown>): ORCOperationalRoleMetadata {
...
function classifyRole(args: { entry?: OperationalState["planning"][number] | null; task?: TaskInput | Record<string, unknown> | null; mealWindow?: TimeWindow | null; source?: Record<string, unknown> | null }): ORCOperationalRoleMetadata {
  ...
  if (explicitProductive) role = "productive_task";
  ...
  return roleFlags(role, task, source);
}
...
export function resolveORCPlanningEntryOperationalRoleMetadata(args: { entry?: OperationalState["planning"][number] | null; task?: TaskInput | Record<string, unknown> | null; mealWindow?: TimeWindow | null; source?: Record<string, unknown> | null }): ORCOperationalRoleMetadata { return classifyRole(args); }
export function classifyORCPlanningEntryOperationalRole(args: { entry?: OperationalState["planning"][number] | null; task?: TaskInput | Record<string, unknown> | null; mealWindow?: TimeWindow | null; source?: Record<string, unknown> | null }): ORCPlanningEntryOperationalRole { return classifyRole(args).role; }
