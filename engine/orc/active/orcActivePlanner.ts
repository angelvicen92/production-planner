...
export function runORCActivePlanner(input: EngineInput, options: ORCActivePlannerOptions = {}): ORCActivePlannerResult {
  ...
  const operationalDelta = { v4: v4Metrics, orc: orcMetrics, productionConceptAlignment: compositeSummary.productionConceptAlignment, criticalComparison: { opqmNotWorseThanV4: gates.opqmNotWorseThanV4, rawOpqmNotWorseThanV4: opqmNotWorse(v4Metrics, orcMetrics), opqmGateBypassedForBaselineRepair } };
