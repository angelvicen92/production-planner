...
export function runORCActivePlanner(input: EngineInput, options: ORCActivePlannerOptions = {}): ORCActivePlannerResult {
  ...
  const repairAcceptanceSource = repairAcceptancePolicy != null && (shadowBaselineOverlapRepair?.lateAuditRepairPass as any)?.selectedAsCommit === true ? "late-audit-repair-pass" : repairAcceptancePolicy != null ? "initial-baseline-overlap-repair" : null;
