  ...
  try {
    ...
    const candidateResult: CandidateBuilderResult & { partialPlans?: typeof composed.partialPlans } = {
      ...
      summary: {
        ...
        criticalResourceIdleCompression: { executed: false, reason: "baseline_feasibility_audit", targetResourceIds: [], targetGapCount: 0, generatedCandidateCount: 0, candidateIds: [], prefilterAcceptedCount: 0, prefilterDiscardedCount: 0, candidateStateCount: 0, simulatedStateCount: 0, validSimulationCount: 0, invalidSimulationCount: 0, selectedAsCommit: false, selectedCandidateId: null, selectedSimulatedStateId: null, movedTaskIds: [], targetResourceId: null, targetResourceIdleBefore: null, targetResourceIdleAfter: null, targetResourceIdleReductionMinutes: 0, targetGapBeforeMinutes: null, targetGapAfterMinutes: null, mainZoneContinuityPreserved: true, makespanBefore: null, makespanAfter: null, prefilterDiscardReasons: {}, prefilterDiscardDetails: [], candidateGenerationBlockers: ["baseline_feasibility_audit"], validationRejectReasons: [], warnings: [], readOnly: true },
