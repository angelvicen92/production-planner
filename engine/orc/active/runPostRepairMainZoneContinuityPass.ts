...
export interface PostRepairMainZoneContinuityPassSummary {
  executed: boolean; reason: string | null; mainZoneId: number | null; mainZoneConfigured: boolean; mainZoneTargetKind?: string; rawMainZoneId?: number | null; mainSpaceIds?: number[]; mainZoneIds?: number[]; dominantMainSpaceId?: number | null; mainEntryCount?: number; mainProductiveEntryCount?: number; detectedGapCount?: number; candidateGenerationReason?: string | null; candidateGenerationBlockers?: string[]; sourceSimulationId: string | null; sourceRepairCandidateId: string | null;
...
export function runPostRepairMainZoneContinuityPass(args: { originalState: OperationalState; selectedRepairSimulation: SimulatedState | null; selectedRepairValidation: ValidationResult | null; selectedRepairedPlanning?: readonly unknown[]; baselineOverlapRepair: unknown; createdAt?: string | null; budget?: { maxCandidates?: number } }): PostRepairMainZoneContinuityPassResult {
  ...
  if (!built.mainZoneContinuity.mainZoneConfigured) return empty("main_zone_not_configured", { sourceSimulationId: args.selectedRepairSimulation.id, mainZoneId: built.mainZoneContinuity.mainZoneId, mainZoneConfigured: false, mainZoneTargetKind: built.mainZoneContinuity.targetKind, rawMainZoneId: built.mainZoneContinuity.rawMainZoneId, mainSpaceIds: built.mainZoneContinuity.mainSpaceIds, mainZoneIds: built.mainZoneContinuity.mainZoneIds, dominantMainSpaceId: built.mainZoneContinuity.dominantMainSpaceId, mainEntryCount: built.mainZoneContinuity.mainEntryCount, mainProductiveEntryCount: built.mainZoneContinuity.mainProductiveEntryCount, detectedGapCount: built.mainZoneContinuity.mainZoneGapCount });
