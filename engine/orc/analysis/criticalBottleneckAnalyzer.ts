...
export function analyzeCriticalBottlenecks(analysis: Omit<OperationalAnalysis, "criticalBottleneckAnalysis" | "resourceCriticalityAnalysis" | "constraintPressureAnalysis"> | OperationalAnalysis): CriticalBottleneckAnalysis {
