...
type ResourceCriticalityInput = Omit<OperationalAnalysis, "resourceCriticalityAnalysis" | "constraintPressureAnalysis" | "operationalPriorityMap"> | OperationalAnalysis;
