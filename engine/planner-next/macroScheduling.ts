...
/**
 * Exact domains use MRV and take precedence over inexact measurements. Inexact
 * domains use semantic pressure only when no exact domain remains. A sound zero
 * remains stronger than either policy.
 */
