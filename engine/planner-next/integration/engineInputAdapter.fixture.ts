...
export function createSupportedEngineInputAdapterFixture(): EngineInput {
  return {
    ...
    tasks: [
      ...
      task(103, { plannerNextKind: "main", contestantId: 202, spaceId: 301, zoneId: 401, assignedResourceIds: [502], dependsOnTaskIds: [104] }),
      task(104, { plannerNextKind: "vocal", contestantId: 202, spaceId: 302, zoneId: 402, assignedResourceIds: [502] }),
    ...
    vocalCoachPlanResourceItemIdByContestantId: { 201: 501, 202: 502 },
