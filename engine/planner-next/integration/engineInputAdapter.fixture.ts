...
export function createSupportedEngineInputAdapterFixture(): EngineInput {
  return {
    ...
    camerasAvailable: 0,
    tasks: [
      task(101, { plannerNextKind: "main", contestantId: 201, spaceId: 301, zoneId: 401, assignedResourceIds: [501] }),
      task(102, { plannerNextKind: "auxiliary", contestantId: 202, spaceId: 302, zoneId: 402, dependsOnTaskIds: [101] }),
      task(103, { plannerNextKind: "technical", spaceId: 302, zoneId: 402 }),
    ],
    locks: [],
    planZoneSettings: [
    ...
    spaceResourceAssignments: { 302: [502] },
    zoneResourceAssignments: { 402: [503] },
