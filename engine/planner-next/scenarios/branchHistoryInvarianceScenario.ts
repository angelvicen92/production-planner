...
export function branchHistoryIsolatedPruningScenario(): PlannerNextProblem {
  ...
  const tasks: Task[] = [
    { id: isolatedTaskIds[0], kind: "auxiliary", participantId: "participant-z", duration: 25, spaceId: "isolated-space-a", dependencies: [], requiredResourceIds: ["isolated-resource"] },
    { id: isolatedTaskIds[1], kind: "auxiliary", participantId: "participant-e", duration: 5, spaceId: "isolated-space-b", dependencies: [], requiredResourceIds: ["isolated-resource"] },
  ];
