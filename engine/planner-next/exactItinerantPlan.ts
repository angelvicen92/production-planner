...
export function runExactItinerantPlanSearch(problem: PlannerNextProblem,
  ...
  const evidence: ExactItinerantPlanEvidence = {
    ...
    arrivalInjectiveEnvelopeChecks:0,arrivalInjectiveEnvelopePrunes:0,arrivalInjectiveEdgeDeadlineChecks:0,
    arrivalInjectiveMaxMatchingChecks:0,firstArrivalInjectiveCertificate:null,
