...
const invariantChecks: ReadonlyArray<[string, (expansion: ExpandedCanonicalFullA2Template) => ValidationIssue[]]> = [
  ...
  ["EFFECTIVE_CONFIGURATION", (expansion) => {
    ...
    const transportValid = c.transportPolicy.arrival.targetGroupSize === 3 && c.transportPolicy.arrival.maximumGroupSize === 3 && c.transportPolicy.arrival.minGapMinutes === 30 && c.transportPolicy.arrival.groupingWeight === 3 && c.transportPolicy.departure.targetGroupSize === 1 && c.transportPolicy.departure.maximumGroupSize === 3 && c.transportPolicy.departure.minGapMinutes === 20 && c.transportPolicy.departure.groupingWeight === 3;
