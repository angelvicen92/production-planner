...
export interface CanonicalTemplateRules {
  ...
  readonly inTransport: { readonly minimumGroupSize: 3; readonly maximumGroupSize: 6; readonly minGapMinutes: 35; readonly groupingWeight: 3 };
  readonly outTransport: { readonly minimumGroupSize: 3; readonly maximumGroupSize: 6; readonly minGapMinutes: 20; readonly groupingWeight: 3 };
...
export interface RepresentabilityAnalysis {
  ...
  readonly transportPolicyProbe: { readonly sourceConfigurationPresent: boolean; readonly engineInputContractPresent: boolean; readonly transportSettingsSourcePresent: boolean; readonly engineInputPreflightSupported: boolean; readonly rejectsInvalidContracts: boolean; readonly adapterProjectsTransportPolicy: boolean; readonly plannerNextContractPresent: boolean; readonly minimumPreserved: boolean; readonly maximumPreserved: boolean; readonly minGapPreserved: boolean; readonly groupingWeightPreserved: boolean; readonly noSeparateTargetSemantic: boolean; readonly capabilityDetected: boolean; readonly capabilityUnsupported: boolean; readonly executionFailsClosed: boolean; readonly deterministic: boolean; readonly orderInvariant: boolean; readonly inputImmutable: boolean };
