...
assert.ok(first.evidence.branchesExplored <= 216_566);
...
assert.equal(first.evidence.coreFingerprint, "c85b9b2cfbbf9434135f08e2b293b0ab6c23e5ff070e880cbb5406022dd52785");
