...
export type ParticipantBoundaryRoleInput = "ENTRY_PREREQUISITE" | "EXIT_PREREQUISITE";
...
export interface TaskInput {
  ...
  camerasOverride?: number | null;
    ...
    dependsOnTaskId?: number | null; // resuelto en buildInput (por concursante)
      ...
      /** Explicit terminal-presence role; never inferred from task identity or shape. */
      participantBoundaryRole?: ParticipantBoundaryRoleInput;
      blocksSpace?: boolean;
...
export interface EngineInput {
  ...
  /** Legacy product name for the preferred arrival group size. */
  arrivalGroupingTarget?: number;
  /** Legacy product name for the preferred departure group size. */
  ...
  transportSettings?: {
    ...
    /** Alias of the preferred arrival group size. */
    arrivalTargetGroupSize?: number | null;
    /** Alias of the preferred departure group size. */
...
export interface EngineOutput {
  ...
  v3Meta?: {
    ...
    productionWaveAnchorWindowStart?: string;
    productionWaveAnchorWindowEnd?: string;
    ...
    productionWaveCoachGapBefore?: number;
    productionWaveCoachGapAfter?: number;
    productionWaveMakespanBefore?: number;
    ...
    pipelineConflictDetails?: Array<{
      ...
      conflictKind?: "exclusive_lane_capacity" | "break_window_blocker" | "fixed_task_blocker" | "movable_task_conflict" | "dependency_chain_conflict" | "unknown";
