...
export function runInitialConstructionBenchmarkFromInput(input: any, reasoningBudget: Record<string, unknown> = {}): InitialConstructionBenchmarkResult {
  ...
  return {
    ...
    stage2PriorityCarrierTaskId: stage2?.stage2PriorityCarrierTaskId ?? null,
    stage2ConstructionGoalTaskId: stage2?.stage2ConstructionGoalTaskId ?? null,
    stage2GoalResolutionSource: stage2?.stage2GoalResolutionSource ?? null,
    stage2GoalCoupledClosureTaskIds: stage2?.stage2GoalCoupledClosureTaskIds ?? [],
    stage2GoalCoupledClosureTaskCount: stage2?.stage2GoalCoupledClosureTaskCount ?? 0,
    stage2GoalIncludedInSelectedAssignments: stage2?.stage2GoalIncludedInSelectedAssignments ?? null,
    stage2GoalCoupledFingerprint: stage2?.stage2GoalCoupledFingerprint ?? null,
