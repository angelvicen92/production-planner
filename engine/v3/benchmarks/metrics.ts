...
export const calculateMetrics = (input: EngineV3Input, output: EngineOutput, runtimeMs: number): EngineBenchmarkMetrics => {
  ...
  return {
    ...
    coachCompactionAttempted: output.v3Meta?.coachCompactionAttempted ?? null,
    coachCompactionCandidatesGenerated: output.v3Meta?.coachCompactionCandidatesGenerated ?? null,
    coachCompactionRejectedReasons: output.v3Meta?.coachCompactionRejectedReasons ?? null,
    coachCompactionTargetedCoaches: output.v3Meta?.coachCompactionTargetedCoaches ?? null,
    coachCompactionBestBefore: output.v3Meta?.coachCompactionBestBefore ?? null,
    coachCompactionBestAfter: output.v3Meta?.coachCompactionBestAfter ?? null,
    ...blockerSummary,
