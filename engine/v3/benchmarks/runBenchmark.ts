...
const QUICK_SCENARIO_IDS = ["A", "G", "H", "I", "L", "R", "S", "T", "U", "V", "W", "X"] as const;
...
console.log("ENGINE V3 BENCHMARK — ID 004 + ID 006 + ID 007 + ID 008 + ID 009 + ID 010 + ID 011 + ID 012 + ID 013 + ID 014 + ID 015 + ID 016 + ID 017 + ID 019 + ID 020 + ID 026 + ID 027 + ID 028");
