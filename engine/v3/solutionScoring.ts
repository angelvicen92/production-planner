...
export type CandidateSource = "phaseA_greedy" | "phaseA_backtracking" | "operational_neighborhood" | "production_wave_builder" | "pipeline_builder" | "segment_solver" | "cp_sat_pilot" | "cp_sat" | "fallback" | "infeasible";
