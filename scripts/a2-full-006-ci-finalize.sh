...
printf '%s\n' "${changed[@]}"
allowed_re='^(README\.md|engine/planner-next/benchmarks/focal-a2/full-day/validate\.ts|engine/planner-next/benchmarks/__tests__/fullA2ItinerantAvailabilityValidation\.test\.ts|docs/evidence/SPEC10-016-full-a2-canonical-template\.json|docs/coverage/SPEC10-016-FULL-A2-TEMPLATE\.md|\.github/workflows/baseline-ci\.yml|scripts/a2-full-006-ci-finalize\.sh)$'
for f in "${changed[@]}"; do
