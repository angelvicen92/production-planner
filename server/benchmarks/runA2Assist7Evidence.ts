...
export async function runA2Assist7Evidence() {
  ...
  assert.ok(followupRun && followupTaskId !== undefined, `no later canonical A2 scope can continue around the accepted HARD baseline: ${JSON.stringify(followupDiagnostics)}`);
